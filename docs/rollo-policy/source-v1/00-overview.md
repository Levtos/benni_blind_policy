...
**Scope:**
- Berechnung des aktiven Rollo-Modus über eine Prioritätskasse
...
|---|---|---|---|
| Rollo Ziel-Modus | Enum | Aktiver Modus der Prioritätskette | Siehe §4.1 |
...
## 11. INTEGRATIONS- & HACS-ABHÄNGIGKEITEN
